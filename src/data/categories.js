...
const CATEGORY_META_RAW = [
  ...
  { id: 'frameworks-libs',     title: '프레임워크·라이브러리',      icon: '🧱', groupId: 'dev',       itemCount: 17 },
  ...
  { id: 'web-templates',       title: '웹디자인 템플릿',            icon: '📐', groupId: 'creative',  itemCount: 9  },
...
export const DATA_LOADERS = {
  ...
  'frameworks-libs':      () => import('./frameworks-libs.json'),
  'api':                  () => import('./api.json'),
  ...
  'web-templates':        () => import('./web-templates.json'),
